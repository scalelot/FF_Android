...
public class UserSelectionAdapter extends RecyclerView.Adapter<UserSelectionAdapter.MyDataViewHolder> {
    ...
    public void setOnItemClickListener(RemoveClickListener clickListener) {
        UserSelectionAdapter.removeClickListener = clickListener;
    }

    public UserSelectionAdapter(Context context, ArrayList<CreateGroupModel> user_name) {
    ...
    public MyDataViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.selected_contact_list, parent, false);
