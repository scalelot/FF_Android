package com.festum.festumfield.Model.Product;
...
public class ProductDataModel {
    @SerializedName("docs")
    @Expose
    private List<ProductDetailsModel> docs = null;
    ...
    public List<ProductDetailsModel> getDocs() {
        return docs;
    }

    public void setDocs(List<ProductDetailsModel> docs) {
        this.docs = docs;
    }
