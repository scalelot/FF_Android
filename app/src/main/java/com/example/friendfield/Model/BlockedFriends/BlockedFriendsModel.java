package com.example.friendfield.Model.BlockedFriends;
...
public class BlockedFriendsModel {
    @SerializedName("docs")
    @Expose
    private List<BlockedFriendRegisterModel> docs = null;
    ...
    public List<BlockedFriendRegisterModel> getDocs() {
        return docs;
    }

    public void setDocs(List<BlockedFriendRegisterModel> docs) {
        this.docs = docs;
    }
