package com.example.friendfield.Model.ReceiveFriendsList;
...
public class ReceiveFriendsRequestModel {

    @SerializedName("docs")
    @Expose
    private List<ReceiveFriendsRegisterModel> docs = null;
    ...
    public List<ReceiveFriendsRegisterModel> getDocs() {
        return docs;
    }

    public void setDocs(List<ReceiveFriendsRegisterModel> docs) {
        this.docs = docs;
    }
