package com.example.friendfield.Model.AllMyFriends;
...
public class AllMyFriendsModel {
    @SerializedName("docs")
    @Expose
    private List<AllFriendsRegisterModel> docs = null;
    ...
    public List<AllFriendsRegisterModel> getDocs() {
        return docs;
    }

    public void setDocs(List<AllFriendsRegisterModel> docs) {
        this.docs = docs;
    }
